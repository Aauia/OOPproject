...
public class Teacher extends Employee {
    ...
    public void putMark(int semester, String studentId, String courseCode, Mark mark) {
        ...
        // Ensure the course in the transcript is the same instance
        Transcript transcript = student.getTranscript();
        List<Course> semesterCourses = student.getCurriculum().getSemesterCourses().get(semester);
        Course correctCourse = semesterCourses.stream()
                                              .filter(c -> c.getCourseCode().equals(courseCode))
                                              .findFirst()
                                              .orElse(null);

        if (correctCourse == null) {
            System.out.println("Error: Course not found in student's curriculum for the given semester.");
            return;
        }

        // Add the mark to the transcript
        transcript.addMarksForCourse(semester, correctCourse, mark);
        System.out.println("Mark added to " + student.getName() + "'s transcript for course: " + correctCourse.getCourseName());
    }
    ...
    public void addCourse(Course course) {
        ...
        System.out.println("Course " + course.getCourseCode() + " successfully assigned to " + this.getName());
    }
